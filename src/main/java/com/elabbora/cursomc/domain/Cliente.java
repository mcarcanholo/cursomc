...
public class Cliente implements Serializable{
	...
	//Set é um conjunto. Conjunto não aceita repetição
	//Para gravar os vários telefones de um mesmo cliente, será usado esse recurso, não será criada uma classe.
	@ElementCollection
	...
	//Implementação que faz o retorno do Tipo Cliente
